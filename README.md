...
```html
<a href="https://line.me/ti/p/~LINE_ID">ทัก LINE</a>
```

ลิงก์แบบ `line://...` เปิดแอปตรงกว่า แต่บางเครื่องอาจเปิด LINE แล้วเด้งออก จึงแนะนำให้ใช้ `https://line.me/...` สำหรับเว็บที่เปิดผ่าน GitHub Pages
